...
<div class="register-box">
  <div class="register-logo">
      <a href="../User/index.php"><b>HUT</b>Bazar</a>
  </div>
         ...
         <?php
                if (isset($_POST['submit'])) {
                    ...
                    if ($password == $rpassword) {
                        ...
                        $insert = mysql_query("INSERT INTO regis(id,fir_name,las_name,email,password,confm_password) VALUES('','$first_name','$last_name','$email','$password','$rpassword')");
                        if ($insert) {
                             header("location:login.php");
                        } else {
                            echo "Sorry , Registration is not successfully.";
                        }
                    }
                    else {
