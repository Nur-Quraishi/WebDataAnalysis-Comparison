        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            ...
            <li>
             ...
             <li>
                 <a href="navbar.php"><img src="../User/image/icon/kids.png" alt="HTML5 Icon" style="width:30px;height:30px;">Kids</a>
            </li>
            <li>
                <a href="cards.php"><img src="../User/image/icon/elec.png" alt="HTML5 Icon" style="width:30px;height:30px;">Electronics</a>
            </li>
          </ul>
        </li>
